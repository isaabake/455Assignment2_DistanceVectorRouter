...
The python script changelink.py also works properly and takes 4 parameters: testdir router1 router2 cost

This program uses the config files provided by Dr.Hauser for ease of use. The associated python scripts for generating tests are also functional.
